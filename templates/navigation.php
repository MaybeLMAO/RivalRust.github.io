        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?php if(isOnPage('index.php')) { echo 'active'; } ?>" href="index.php#home">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#servers">Servers</a>
                    </li>
					<?php if($config['store']['enabled'] == 'yes') { ?>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php#store"><?php echo $config['store']['navigation']; ?></a>
                        </li>
					<?php } ?>
				...
				<?php if($config['socials']['enabled'] == 'yes') { ?>
                    <div class="socials">
						...
						<?php if($config['socials']['links']['tiktok'] != '') { ?>
                            <a href="<?php echo $config['socials']['links']['tiktok']; ?>" target="_blank" title="Vk">
                                <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
